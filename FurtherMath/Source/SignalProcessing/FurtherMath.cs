...
namespace FurtherMath.SignalProcessing
{
    enum WindowType
    {
        Rectangle,
    ...
    public static class SignalFunctions
    {    
        ...
        public static void stfft(int N, double[] xRe, double[] xIm,
                                 out double[][] yRe, out double[][] yIm)
        {
            stfft(N, SignalFunctions.WindowLength, HopSize, xRe, xIm, out yRe, out yIm, -1);
        }
        ...
        {
            stfft(N, SignalFunctions.WindowLength, HopSize, xRe, xIm, out yRe, out yIm, numberOfFrames);
        }
        /// <summary>
        ///  Short Time Fourier Transform. 
        /// </summary>
