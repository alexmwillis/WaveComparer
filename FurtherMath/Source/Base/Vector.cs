...
{
    public struct Vector : ICollection
    {
        double[] _vector;
        ...
        public double this[int i] { 
            ...
            set
            {
                // *TODO This hides error, however binding tries to set this to NaN, which shouldn't raise an exception
        ...
        {
            return HashCodeUtils.CombineHashCodes(_vector);
        }
